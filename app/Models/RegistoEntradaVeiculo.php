...
class RegistoEntradaVeiculo extends Model implements HasMedia
{
    ...
    protected $fillable = [
        ...
        'lateral_esquerda_porta_dianteira',
        'lateral_esquerda_porta_traseira',
        'lateral_esquerda_lateral',
        'lateral_esquerda_nada_consta',
        'lateral_esquerda_obs',
        'traseira_mala',
        'traseira_farol_direito',
        'traseira_farol_esquerdo',
        'traseira_parachoque_traseiro',
    ...
    public function getCartaVerdeDeSeguroDataAttribute($value)
    {
        return $value ? Carbon::parse($value)->format(config('panel.date_format')) : null;
    }

    public function setCartaVerdeDeSeguroDataAttribute($value)
    {
        $this->attributes['carta_verde_de_seguro_data'] = $value ? Carbon::createFromFormat(config('panel.date_format'), $value)->format('Y-m-d') : null;
    }
