        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.driverClass.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.driver-classes.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('to') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="to" id="to" value="{{ old('to', '') }}" step="0.01" required>
                            @if($errors->has('to'))
                        ...
                        <div class="form-group {{ $errors->has('minimum_value') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="minimum_value" id="minimum_value" value="{{ old('minimum_value', '') }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('additional_commission') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="additional_commission" id="additional_commission" value="{{ old('additional_commission', '') }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('time_for_loyalty_bonus') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="time_for_loyalty_bonus" id="time_for_loyalty_bonus" value="{{ old('time_for_loyalty_bonus', '') }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('value_of_the_loyalty_bonus') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="value_of_the_loyalty_bonus" id="value_of_the_loyalty_bonus" value="{{ old('value_of_the_loyalty_bonus', '') }}" step="0.01">
