                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group {{ $errors->has('type') ? 'has-error' : '' }}">
                                                    ...
                                                    @foreach(App\Models\RecruitmentForm::TYPE_RADIO as $key => $label)
                                                        <div>
                                                            <input type="radio" id="type_{{ $key }}" name="type" value="{{ $key }}" {{ old('type', 'TVDE Frota') === (string) $key ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group {{ $errors->has('chanel') ? 'has-error' : '' }}">
                                                    ...
                                                    @foreach(App\Models\RecruitmentForm::CHANEL_RADIO as $key => $label)
                                                        <div>
                                                            <input type="radio" id="chanel_{{ $key }}" name="chanel" value="{{ $key }}" {{ old('chanel', '') === (string) $key ? 'checked' : '' }}>
