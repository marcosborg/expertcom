                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group {{ $errors->has('not_recruited_reason') ? 'has-error' : '' }}">
                                            ...
                                            <select class="form-control" name="not_recruited_reason" id="not_recruited_reason">
                                                <option value="" {{ old('not_recruited_reason', $recruitmentForm->not_recruited_reason ?? '') === '' ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                                                @foreach(App\Models\RecruitmentForm::NOT_RECRUITED_REASON_RADIO as $key => $label)
                                                    <option value="{{ $key }}" {{ old('not_recruited_reason', $recruitmentForm->not_recruited_reason ?? '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                                @endforeach
                                            </select>
