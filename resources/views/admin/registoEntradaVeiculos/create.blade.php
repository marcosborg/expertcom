                    ...
                    <form method="POST" action="{{ route("admin.registo-entrada-veiculos.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('frente_do_veiculo_teto') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="frente_do_veiculo_teto" id="frente_do_veiculo_teto" value="1" {{ old('frente_do_veiculo_teto', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('frente_do_veiculo_parabrisa') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="frente_do_veiculo_parabrisa" id="frente_do_veiculo_parabrisa" value="1" {{ old('frente_do_veiculo_parabrisa', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('frente_do_veiculo_capo') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="frente_do_veiculo_capo" id="frente_do_veiculo_capo" value="1" {{ old('frente_do_veiculo_capo', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('frente_do_veiculo_parachoque') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="frente_do_veiculo_parachoque" id="frente_do_veiculo_parachoque" value="1" {{ old('frente_do_veiculo_parachoque', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('frente_do_veiculo_nada_consta') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="frente_do_veiculo_nada_consta" id="frente_do_veiculo_nada_consta" value="1" {{ old('frente_do_veiculo_nada_consta', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('frente_do_veiculo_obs') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="frente_do_veiculo_obs" id="frente_do_veiculo_obs">{{ old('frente_do_veiculo_obs') }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('lateral_esquerda_paralama_diant') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="lateral_esquerda_paralama_diant" id="lateral_esquerda_paralama_diant" value="1" {{ old('lateral_esquerda_paralama_diant', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('lateral_esquerda_retrovisor') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="lateral_esquerda_retrovisor" id="lateral_esquerda_retrovisor" value="1" {{ old('lateral_esquerda_retrovisor', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('lateral_esquerda_porta_diant') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="lateral_esquerda_porta_diant" id="lateral_esquerda_porta_diant" value="1" {{ old('lateral_esquerda_porta_diant', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('lateral_esquerda_porta_tras') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="lateral_esquerda_porta_tras" id="lateral_esquerda_porta_tras" value="1" {{ old('lateral_esquerda_porta_tras', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('lateral_esquerda_lateral') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="lateral_esquerda_lateral" id="lateral_esquerda_lateral" value="1" {{ old('lateral_esquerda_lateral', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('lateral_esquerda_nada_consta') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="lateral_esquerda_nada_consta" id="lateral_esquerda_nada_consta" value="1" {{ old('lateral_esquerda_nada_consta', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('lateral_esquerda_obs') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="lateral_esquerda_obs" id="lateral_esquerda_obs">{{ old('lateral_esquerda_obs') }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('traseira_mala') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="traseira_mala" id="traseira_mala" value="1" {{ old('traseira_mala', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('traseira_farol_dir') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="traseira_farol_dir" id="traseira_farol_dir" value="1" {{ old('traseira_farol_dir', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('traseira_farol_esq') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="traseira_farol_esq" id="traseira_farol_esq" value="1" {{ old('traseira_farol_esq', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('traseira_parachoque_tras') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="traseira_parachoque_tras" id="traseira_parachoque_tras" value="1" {{ old('traseira_parachoque_tras', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('traseira_pneu_reserva') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="traseira_pneu_reserva" id="traseira_pneu_reserva" value="1" {{ old('traseira_pneu_reserva', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('traseira_macaco') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="traseira_macaco" id="traseira_macaco" value="1" {{ old('traseira_macaco', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('traseira_chave_de_roda') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="traseira_chave_de_roda" id="traseira_chave_de_roda" value="1" {{ old('traseira_chave_de_roda', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('traseira_triangulo') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="traseira_triangulo" id="traseira_triangulo" value="1" {{ old('traseira_triangulo', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('traseira_nada_consta') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="traseira_nada_consta" id="traseira_nada_consta" value="1" {{ old('traseira_nada_consta', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('traseira_obs') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="traseira_obs" id="traseira_obs">{{ old('traseira_obs') }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('lateral_direita_lateral') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="lateral_direita_lateral" id="lateral_direita_lateral" value="1" {{ old('lateral_direita_lateral', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('lateral_direita_porta_tras') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="lateral_direita_porta_tras" id="lateral_direita_porta_tras" value="1" {{ old('lateral_direita_porta_tras', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('lateral_direita_porta_diant') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="lateral_direita_porta_diant" id="lateral_direita_porta_diant" value="1" {{ old('lateral_direita_porta_diant', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('lateral_direita_retrovisor') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="lateral_direita_retrovisor" id="lateral_direita_retrovisor" value="1" {{ old('lateral_direita_retrovisor', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('lateral_direita_paralama_diant') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="lateral_direita_paralama_diant" id="lateral_direita_paralama_diant" value="1" {{ old('lateral_direita_paralama_diant', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('lateral_direita_nada_consta') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="lateral_direita_nada_consta" id="lateral_direita_nada_consta" value="1" {{ old('lateral_direita_nada_consta', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('lateral_direita_obs') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="lateral_direita_obs" id="lateral_direita_obs">{{ old('lateral_direita_obs') }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('cinzeiro_sim') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="cinzeiro_sim" id="cinzeiro_sim" value="1" {{ old('cinzeiro_sim', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('cinzeiro_nada_consta') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="cinzeiro_nada_consta" id="cinzeiro_nada_consta" value="1" {{ old('cinzeiro_nada_consta', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('aspiracao_bancos_frente') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="aspiracao_bancos_frente" id="aspiracao_bancos_frente" value="1" {{ old('aspiracao_bancos_frente', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('aspiracao_bancos_tras') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="aspiracao_bancos_tras" id="aspiracao_bancos_tras" value="1" {{ old('aspiracao_bancos_tras', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('aspiracao_tapetes_e_chao_frente') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="aspiracao_tapetes_e_chao_frente" id="aspiracao_tapetes_e_chao_frente" value="1" {{ old('aspiracao_tapetes_e_chao_frente', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('aspiracao_tapetes_e_chao_tras') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="aspiracao_tapetes_e_chao_tras" id="aspiracao_tapetes_e_chao_tras" value="1" {{ old('aspiracao_tapetes_e_chao_tras', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('limpeza_e_brilho_de_plasticos_carro') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="limpeza_e_brilho_de_plasticos_carro" id="limpeza_e_brilho_de_plasticos_carro" value="1" {{ old('limpeza_e_brilho_de_plasticos_carro', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('ambientador_de_carro') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="ambientador_de_carro" id="ambientador_de_carro" value="1" {{ old('ambientador_de_carro', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('limpeza_vidros_interiores') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="limpeza_vidros_interiores" id="limpeza_vidros_interiores" value="1" {{ old('limpeza_vidros_interiores', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('retirar_os_objetos_pessoais_existentes_no_carro') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="retirar_os_objetos_pessoais_existentes_no_carro" id="retirar_os_objetos_pessoais_existentes_no_carro" value="1" {{ old('retirar_os_objetos_pessoais_existentes_no_carro', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('verificacao_de_luzes_no_painel') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="verificacao_de_luzes_no_painel" id="verificacao_de_luzes_no_painel" value="1" {{ old('verificacao_de_luzes_no_painel', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('verificacao_de_necessidade_de_lavagem_estofos') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="verificacao_de_necessidade_de_lavagem_estofos" id="verificacao_de_necessidade_de_lavagem_estofos" value="1" {{ old('verificacao_de_necessidade_de_lavagem_estofos', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('check_list_aspiracao_obs') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="check_list_aspiracao_obs" id="check_list_aspiracao_obs">{{ old('check_list_aspiracao_obs') }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('copia_de_licenca_de_tvde') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="copia_de_licenca_de_tvde" id="copia_de_licenca_de_tvde" value="1" {{ old('copia_de_licenca_de_tvde', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('copia_de_licenca_de_tvde_data') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="copia_de_licenca_de_tvde_data" id="copia_de_licenca_de_tvde_data" value="{{ old('copia_de_licenca_de_tvde_data') }}">
                        ...
                        <div class="form-group {{ $errors->has('copia_de_licenca_de_tvde_comentarios') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="copia_de_licenca_de_tvde_comentarios" id="copia_de_licenca_de_tvde_comentarios" value="{{ old('copia_de_licenca_de_tvde_comentarios', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('carta_verde_de_seguro_validade') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="carta_verde_de_seguro_validade" id="carta_verde_de_seguro_validade" value="1" {{ old('carta_verde_de_seguro_validade', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('carta_verde_de_seguro_validade_data') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="carta_verde_de_seguro_validade_data" id="carta_verde_de_seguro_validade_data" value="{{ old('carta_verde_de_seguro_validade_data') }}">
                        ...
                        <div class="form-group {{ $errors->has('carta_verde_de_seguro_validade_comentarios') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="carta_verde_de_seguro_validade_comentarios" id="carta_verde_de_seguro_validade_comentarios" value="{{ old('carta_verde_de_seguro_validade_comentarios', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('dua_do_veiculo') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="dua_do_veiculo" id="dua_do_veiculo" value="1" {{ old('dua_do_veiculo', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('dua_do_veiculo_data') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="dua_do_veiculo_data" id="dua_do_veiculo_data" value="{{ old('dua_do_veiculo_data') }}">
                        ...
                        <div class="form-group {{ $errors->has('dua_do_veiculo_comentarios') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="dua_do_veiculo_comentarios" id="dua_do_veiculo_comentarios" value="{{ old('dua_do_veiculo_comentarios', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('inspecao_do_veiculo_validade') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="inspecao_do_veiculo_validade" id="inspecao_do_veiculo_validade" value="1" {{ old('inspecao_do_veiculo_validade', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('inspecao_do_veiculo_validade_data') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="inspecao_do_veiculo_validade_data" id="inspecao_do_veiculo_validade_data" value="{{ old('inspecao_do_veiculo_validade_data') }}">
                        ...
                        <div class="form-group {{ $errors->has('inspecao_do_veiculo_validade_comentarios') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="inspecao_do_veiculo_validade_comentarios" id="inspecao_do_veiculo_validade_comentarios" value="{{ old('inspecao_do_veiculo_validade_comentarios', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('contratro_de_prestacao_de_servicos') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="contratro_de_prestacao_de_servicos" id="contratro_de_prestacao_de_servicos" value="1" {{ old('contratro_de_prestacao_de_servicos', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('contratro_de_prestacao_de_servicos_data') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="contratro_de_prestacao_de_servicos_data" id="contratro_de_prestacao_de_servicos_data" value="{{ old('contratro_de_prestacao_de_servicos_data') }}">
                        ...
                        <div class="form-group {{ $errors->has('contratro_de_prestacao_de_servicos_comentarios') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contratro_de_prestacao_de_servicos_comentarios" id="contratro_de_prestacao_de_servicos_comentarios" value="{{ old('contratro_de_prestacao_de_servicos_comentarios', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('distico_tvde_colocado') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="distico_tvde_colocado" id="distico_tvde_colocado" value="1" {{ old('distico_tvde_colocado', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('distico_tvde_colocado_data') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="distico_tvde_colocado_data" id="distico_tvde_colocado_data" value="{{ old('distico_tvde_colocado_data') }}">
                        ...
                        <div class="form-group {{ $errors->has('distico_tvde_colocado_comentarios') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="distico_tvde_colocado_comentarios" id="distico_tvde_colocado_comentarios" value="{{ old('distico_tvde_colocado_comentarios', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('declaracao_amigavel') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="declaracao_amigavel" id="declaracao_amigavel" value="1" {{ old('declaracao_amigavel', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('declaracao_amigavel_data') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="declaracao_amigavel_data" id="declaracao_amigavel_data" value="{{ old('declaracao_amigavel_data') }}">
                        ...
                        <div class="form-group {{ $errors->has('declaracao_amigavel_comentarios') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="declaracao_amigavel_comentarios" id="declaracao_amigavel_comentarios" value="{{ old('declaracao_amigavel_comentarios', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('aplicacao_de_agua_por_todo_o_carro') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="aplicacao_de_agua_por_todo_o_carro" id="aplicacao_de_agua_por_todo_o_carro" value="1" {{ old('aplicacao_de_agua_por_todo_o_carro', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('passagem_de_agua_em_todo_o_carro') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="passagem_de_agua_em_todo_o_carro" id="passagem_de_agua_em_todo_o_carro" value="1" {{ old('passagem_de_agua_em_todo_o_carro', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('aplicacao_de_champo_em_todo_o_carro') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="aplicacao_de_champo_em_todo_o_carro" id="aplicacao_de_champo_em_todo_o_carro" value="1" {{ old('aplicacao_de_champo_em_todo_o_carro', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('esfregar_todo_o_carro_com_a_escova') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="esfregar_todo_o_carro_com_a_escova" id="esfregar_todo_o_carro_com_a_escova" value="1" {{ old('esfregar_todo_o_carro_com_a_escova', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('retirar_com_agua') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="retirar_com_agua" id="retirar_com_agua" value="1" {{ old('retirar_com_agua', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('verificar_sujidades_ainda_existentes') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="verificar_sujidades_ainda_existentes" id="verificar_sujidades_ainda_existentes" value="1" {{ old('verificar_sujidades_ainda_existentes', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('limpeza_de_jantes') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="limpeza_de_jantes" id="limpeza_de_jantes" value="1" {{ old('limpeza_de_jantes', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('possui_triangulo') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="possui_triangulo" id="possui_triangulo" value="{{ old('possui_triangulo', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('possui_extintor') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="possui_extintor" id="possui_extintor" value="1" {{ old('possui_extintor', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('banco_elevatorio_crianca') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="banco_elevatorio_crianca" id="banco_elevatorio_crianca" value="1" {{ old('banco_elevatorio_crianca', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('colete') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="colete" id="colete" value="1" {{ old('colete', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('tratado') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="tratado" id="tratado" value="1" {{ old('tratado', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('reparado') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="reparado" id="reparado" value="1" {{ old('reparado', 0) == 1 ? 'checked' : '' }}>
