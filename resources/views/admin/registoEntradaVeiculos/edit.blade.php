        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.registoEntradaVeiculo.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.registo-entrada-veiculos.update", [$registoEntradaVeiculo->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('data_e_horario') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="data_e_horario" id="data_e_horario" value="{{ old('data_e_horario', $registoEntradaVeiculo->data_e_horario) }}">
                        ...
                        <div class="form-group {{ $errors->has('user') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="user_id" id="user_id" required>
                                @foreach($users as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('user_id') ? old('user_id') : $registoEntradaVeiculo->user->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('user'))
                        ...
                        <div class="form-group {{ $errors->has('driver') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="driver_id" id="driver_id" required>
                                @foreach($drivers as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('driver_id') ? old('driver_id') : $registoEntradaVeiculo->driver->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('vehicle_item') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="vehicle_item_id" id="vehicle_item_id" required>
                                @foreach($vehicle_items as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('vehicle_item_id') ? old('vehicle_item_id') : $registoEntradaVeiculo->vehicle_item->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('bateria_a_chegada') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="bateria_a_chegada" id="bateria_a_chegada" value="{{ old('bateria_a_chegada', $registoEntradaVeiculo->bateria_a_chegada) }}" step="1" required>
                        ...
                        <div class="form-group {{ $errors->has('de_bateria_de_saida') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="de_bateria_de_saida" id="de_bateria_de_saida" value="{{ old('de_bateria_de_saida', $registoEntradaVeiculo->de_bateria_de_saida) }}" step="1" required>
                        ...
                        <div class="form-group {{ $errors->has('km_atual') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="km_atual" id="km_atual" value="{{ old('km_atual', $registoEntradaVeiculo->km_atual) }}" step="1" required>
                        ...
                        <div class="form-group {{ $errors->has('frente_do_veiculo_teto') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="frente_do_veiculo_teto" id="frente_do_veiculo_teto" value="1" {{ $registoEntradaVeiculo->frente_do_veiculo_teto || old('frente_do_veiculo_teto', 0) === 1 ? 'checked' : '' }}>
                                <label for="frente_do_veiculo_teto" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.frente_do_veiculo_teto') }}</label>
                            </div>
                            @if($errors->has('frente_do_veiculo_teto'))
                                <span class="help-block" role="alert">{{ $errors->first('frente_do_veiculo_teto') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.frente_do_veiculo_teto_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('frente_do_veiculo_parabrisa') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="frente_do_veiculo_parabrisa" id="frente_do_veiculo_parabrisa" value="1" {{ $registoEntradaVeiculo->frente_do_veiculo_parabrisa || old('frente_do_veiculo_parabrisa', 0) === 1 ? 'checked' : '' }}>
                                <label for="frente_do_veiculo_parabrisa" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.frente_do_veiculo_parabrisa') }}</label>
                            </div>
                            @if($errors->has('frente_do_veiculo_parabrisa'))
                                <span class="help-block" role="alert">{{ $errors->first('frente_do_veiculo_parabrisa') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.frente_do_veiculo_parabrisa_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('frente_do_veiculo_capo') ? 'has-error' : '' }}">
                            <div>
                                <input type="hidden" name="frente_do_veiculo_capo" value="0">
                                <input type="checkbox" name="frente_do_veiculo_capo" id="frente_do_veiculo_capo" value="1" {{ $registoEntradaVeiculo->frente_do_veiculo_capo || old('frente_do_veiculo_capo', 0) === 1 ? 'checked' : '' }}>
                                <label for="frente_do_veiculo_capo" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.frente_do_veiculo_capo') }}</label>
                            </div>
                            @if($errors->has('frente_do_veiculo_capo'))
                                <span class="help-block" role="alert">{{ $errors->first('frente_do_veiculo_capo') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.frente_do_veiculo_capo_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('frente_do_veiculo_parachoque') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="frente_do_veiculo_parachoque" id="frente_do_veiculo_parachoque" value="1" {{ $registoEntradaVeiculo->frente_do_veiculo_parachoque || old('frente_do_veiculo_parachoque', 0) === 1 ? 'checked' : '' }}>
                                <label for="frente_do_veiculo_parachoque" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.frente_do_veiculo_parachoque') }}</label>
                            </div>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.frente_do_veiculo_parachoque_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('frente_do_veiculo_nada_consta') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="frente_do_veiculo_nada_consta" id="frente_do_veiculo_nada_consta" value="1" {{ $registoEntradaVeiculo->frente_do_veiculo_nada_consta || old('frente_do_veiculo_nada_consta', 0) === 1 ? 'checked' : '' }}>
                                <label for="frente_do_veiculo_nada_consta" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.frente_do_veiculo_nada_consta') }}</label>
                            </div>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.frente_do_veiculo_nada_consta_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('frente_do_veiculo_obs') ? 'has-error' : '' }}">
                            <label for="frente_do_veiculo_obs">{{ trans('cruds.registoEntradaVeiculo.fields.frente_do_veiculo_obs') }}</label>
                            <textarea class="form-control" name="frente_do_veiculo_obs" id="frente_do_veiculo_obs">{{ old('frente_do_veiculo_obs', $registoEntradaVeiculo->frente_do_veiculo_obs) }}</textarea>
                            @if($errors->has('frente_do_veiculo_obs'))
                                <span class="help-block" role="alert">{{ $errors->first('frente_do_veiculo_obs') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.frente_do_veiculo_obs_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('frente_do_veiculo_teto_photos') ? 'has-error' : '' }}">
                            <label for="frente_do_veiculo_teto_photos">{{ trans('cruds.registoEntradaVeiculo.fields.frente_do_veiculo_teto_photos') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.frente_do_veiculo_teto_photos_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('frente_do_veiculo_parabrisa_photos') ? 'has-error' : '' }}">
                            <label for="frente_do_veiculo_parabrisa_photos">{{ trans('cruds.registoEntradaVeiculo.fields.frente_do_veiculo_parabrisa_photos') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.frente_do_veiculo_parabrisa_photos_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('frente_do_veiculo_capo_photos') ? 'has-error' : '' }}">
                            <label for="frente_do_veiculo_capo_photos">{{ trans('cruds.registoEntradaVeiculo.fields.frente_do_veiculo_capo_photos') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.frente_do_veiculo_capo_photos_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('frente_do_veiculo_parachoque_photos') ? 'has-error' : '' }}">
                            <label for="frente_do_veiculo_parachoque_photos">{{ trans('cruds.registoEntradaVeiculo.fields.frente_do_veiculo_parachoque_photos') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.frente_do_veiculo_parachoque_photos_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('lateral_esquerda_paralama_diant') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="lateral_esquerda_paralama_diant" id="lateral_esquerda_paralama_diant" value="1" {{ $registoEntradaVeiculo->lateral_esquerda_paralama_diant || old('lateral_esquerda_paralama_diant', 0) === 1 ? 'checked' : '' }}>
                                <label for="lateral_esquerda_paralama_diant" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_esquerda_paralama_diant') }}</label>
                            </div>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_esquerda_paralama_diant_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('lateral_esquerda_retrovisor') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="lateral_esquerda_retrovisor" id="lateral_esquerda_retrovisor" value="1" {{ $registoEntradaVeiculo->lateral_esquerda_retrovisor || old('lateral_esquerda_retrovisor', 0) === 1 ? 'checked' : '' }}>
                                <label for="lateral_esquerda_retrovisor" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_esquerda_retrovisor') }}</label>
                            </div>
                            @if($errors->has('lateral_esquerda_retrovisor'))
                                <span class="help-block" role="alert">{{ $errors->first('lateral_esquerda_retrovisor') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_esquerda_retrovisor_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('lateral_esquerda_porta_diant') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="lateral_esquerda_porta_diant" id="lateral_esquerda_porta_diant" value="1" {{ $registoEntradaVeiculo->lateral_esquerda_porta_diant || old('lateral_esquerda_porta_diant', 0) === 1 ? 'checked' : '' }}>
                                <label for="lateral_esquerda_porta_diant" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_esquerda_porta_diant') }}</label>
                            </div>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_esquerda_porta_diant_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('lateral_esquerda_porta_tras') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="lateral_esquerda_porta_tras" id="lateral_esquerda_porta_tras" value="1" {{ $registoEntradaVeiculo->lateral_esquerda_porta_tras || old('lateral_esquerda_porta_tras', 0) === 1 ? 'checked' : '' }}>
                                <label for="lateral_esquerda_porta_tras" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_esquerda_porta_tras') }}</label>
                            </div>
                            @if($errors->has('lateral_esquerda_porta_tras'))
                                <span class="help-block" role="alert">{{ $errors->first('lateral_esquerda_porta_tras') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_esquerda_porta_tras_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('lateral_esquerda_lateral') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="lateral_esquerda_lateral" id="lateral_esquerda_lateral" value="1" {{ $registoEntradaVeiculo->lateral_esquerda_lateral || old('lateral_esquerda_lateral', 0) === 1 ? 'checked' : '' }}>
                                <label for="lateral_esquerda_lateral" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_esquerda_lateral') }}</label>
                            </div>
                            @if($errors->has('lateral_esquerda_lateral'))
                                <span class="help-block" role="alert">{{ $errors->first('lateral_esquerda_lateral') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_esquerda_lateral_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('lateral_esquerda_nada_consta') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="lateral_esquerda_nada_consta" id="lateral_esquerda_nada_consta" value="1" {{ $registoEntradaVeiculo->lateral_esquerda_nada_consta || old('lateral_esquerda_nada_consta', 0) === 1 ? 'checked' : '' }}>
                                <label for="lateral_esquerda_nada_consta" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_esquerda_nada_consta') }}</label>
                            </div>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_esquerda_nada_consta_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('lateral_esquerda_obs') ? 'has-error' : '' }}">
                            <label for="lateral_esquerda_obs">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_esquerda_obs') }}</label>
                            <textarea class="form-control" name="lateral_esquerda_obs" id="lateral_esquerda_obs">{{ old('lateral_esquerda_obs', $registoEntradaVeiculo->lateral_esquerda_obs) }}</textarea>
                            @if($errors->has('lateral_esquerda_obs'))
                                <span class="help-block" role="alert">{{ $errors->first('lateral_esquerda_obs') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_esquerda_obs_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('lateral_esquerda_paralama_diant_photos') ? 'has-error' : '' }}">
                            <label for="lateral_esquerda_paralama_diant_photos">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_esquerda_paralama_diant_photos') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_esquerda_paralama_diant_photos_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('lateral_esquerda_retrovisor_photos') ? 'has-error' : '' }}">
                            <label for="lateral_esquerda_retrovisor_photos">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_esquerda_retrovisor_photos') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_esquerda_retrovisor_photos_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('lateral_esquerda_porta_diant_photos') ? 'has-error' : '' }}">
                            <label for="lateral_esquerda_porta_diant_photos">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_esquerda_porta_diant_photos') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_esquerda_porta_diant_photos_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('lateral_esquerda_porta_tras_photos') ? 'has-error' : '' }}">
                            <label for="lateral_esquerda_porta_tras_photos">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_esquerda_porta_tras_photos') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_esquerda_porta_tras_photos_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('lateral_esquerda_lateral_photos') ? 'has-error' : '' }}">
                            <label for="lateral_esquerda_lateral_photos">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_esquerda_lateral_photos') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_esquerda_lateral_photos_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('traseira_mala') ? 'has-error' : '' }}">
                            <div>
                                <input type="hidden" name="traseira_mala" value="0">
                                <input type="checkbox" name="traseira_mala" id="traseira_mala" value="1" {{ $registoEntradaVeiculo->traseira_mala || old('traseira_mala', 0) === 1 ? 'checked' : '' }}>
                                <label for="traseira_mala" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.traseira_mala') }}</label>
                            </div>
                            @if($errors->has('traseira_mala'))
                                <span class="help-block" role="alert">{{ $errors->first('traseira_mala') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.traseira_mala_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('traseira_farol_dir') ? 'has-error' : '' }}">
                            <div>
                                <input type="hidden" name="traseira_farol_dir" value="0">
                                <input type="checkbox" name="traseira_farol_dir" id="traseira_farol_dir" value="1" {{ $registoEntradaVeiculo->traseira_farol_dir || old('traseira_farol_dir', 0) === 1 ? 'checked' : '' }}>
                                <label for="traseira_farol_dir" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.traseira_farol_dir') }}</label>
                            </div>
                            @if($errors->has('traseira_farol_dir'))
                                <span class="help-block" role="alert">{{ $errors->first('traseira_farol_dir') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.traseira_farol_dir_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('traseira_farol_esq') ? 'has-error' : '' }}">
                            <div>
                                <input type="hidden" name="traseira_farol_esq" value="0">
                                <input type="checkbox" name="traseira_farol_esq" id="traseira_farol_esq" value="1" {{ $registoEntradaVeiculo->traseira_farol_esq || old('traseira_farol_esq', 0) === 1 ? 'checked' : '' }}>
                                <label for="traseira_farol_esq" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.traseira_farol_esq') }}</label>
                            </div>
                            @if($errors->has('traseira_farol_esq'))
                                <span class="help-block" role="alert">{{ $errors->first('traseira_farol_esq') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.traseira_farol_esq_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('traseira_parachoque_tras') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="traseira_parachoque_tras" id="traseira_parachoque_tras" value="1" {{ $registoEntradaVeiculo->traseira_parachoque_tras || old('traseira_parachoque_tras', 0) === 1 ? 'checked' : '' }}>
                                <label for="traseira_parachoque_tras" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.traseira_parachoque_tras') }}</label>
                            </div>
                            @if($errors->has('traseira_parachoque_tras'))
                                <span class="help-block" role="alert">{{ $errors->first('traseira_parachoque_tras') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.traseira_parachoque_tras_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('traseira_pneu_reserva') ? 'has-error' : '' }}">
                            <div>
                                <input type="hidden" name="traseira_pneu_reserva" value="0">
                                <input type="checkbox" name="traseira_pneu_reserva" id="traseira_pneu_reserva" value="1" {{ $registoEntradaVeiculo->traseira_pneu_reserva || old('traseira_pneu_reserva', 0) === 1 ? 'checked' : '' }}>
                                <label for="traseira_pneu_reserva" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.traseira_pneu_reserva') }}</label>
                            </div>
                            @if($errors->has('traseira_pneu_reserva'))
                                <span class="help-block" role="alert">{{ $errors->first('traseira_pneu_reserva') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.traseira_pneu_reserva_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('traseira_macaco') ? 'has-error' : '' }}">
                            <div>
                                <input type="hidden" name="traseira_macaco" value="0">
                                <input type="checkbox" name="traseira_macaco" id="traseira_macaco" value="1" {{ $registoEntradaVeiculo->traseira_macaco || old('traseira_macaco', 0) === 1 ? 'checked' : '' }}>
                                <label for="traseira_macaco" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.traseira_macaco') }}</label>
                            </div>
                            @if($errors->has('traseira_macaco'))
                                <span class="help-block" role="alert">{{ $errors->first('traseira_macaco') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.traseira_macaco_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('traseira_chave_de_roda') ? 'has-error' : '' }}">
                            <div>
                                <input type="hidden" name="traseira_chave_de_roda" value="0">
                                <input type="checkbox" name="traseira_chave_de_roda" id="traseira_chave_de_roda" value="1" {{ $registoEntradaVeiculo->traseira_chave_de_roda || old('traseira_chave_de_roda', 0) === 1 ? 'checked' : '' }}>
                                <label for="traseira_chave_de_roda" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.traseira_chave_de_roda') }}</label>
                            </div>
                            @if($errors->has('traseira_chave_de_roda'))
                                <span class="help-block" role="alert">{{ $errors->first('traseira_chave_de_roda') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.traseira_chave_de_roda_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('traseira_triangulo') ? 'has-error' : '' }}">
                            <div>
                                <input type="hidden" name="traseira_triangulo" value="0">
                                <input type="checkbox" name="traseira_triangulo" id="traseira_triangulo" value="1" {{ $registoEntradaVeiculo->traseira_triangulo || old('traseira_triangulo', 0) === 1 ? 'checked' : '' }}>
                                <label for="traseira_triangulo" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.traseira_triangulo') }}</label>
                            </div>
                            @if($errors->has('traseira_triangulo'))
                                <span class="help-block" role="alert">{{ $errors->first('traseira_triangulo') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.traseira_triangulo_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('traseira_nada_consta') ? 'has-error' : '' }}">
                            <div>
                                <input type="hidden" name="traseira_nada_consta" value="0">
                                <input type="checkbox" name="traseira_nada_consta" id="traseira_nada_consta" value="1" {{ $registoEntradaVeiculo->traseira_nada_consta || old('traseira_nada_consta', 0) === 1 ? 'checked' : '' }}>
                                <label for="traseira_nada_consta" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.traseira_nada_consta') }}</label>
                            </div>
                            @if($errors->has('traseira_nada_consta'))
                                <span class="help-block" role="alert">{{ $errors->first('traseira_nada_consta') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.traseira_nada_consta_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('traseira_obs') ? 'has-error' : '' }}">
                            <label for="traseira_obs">{{ trans('cruds.registoEntradaVeiculo.fields.traseira_obs') }}</label>
                            <textarea class="form-control" name="traseira_obs" id="traseira_obs">{{ old('traseira_obs', $registoEntradaVeiculo->traseira_obs) }}</textarea>
                            @if($errors->has('traseira_obs'))
                                <span class="help-block" role="alert">{{ $errors->first('traseira_obs') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.traseira_obs_helper') }}</span>
                        </div>
                        ...
                        <div class="form-group {{ $errors->has('lateral_direita_lateral') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="lateral_direita_lateral" id="lateral_direita_lateral" value="1" {{ $registoEntradaVeiculo->lateral_direita_lateral || old('lateral_direita_lateral', 0) === 1 ? 'checked' : '' }}>
                                <label for="lateral_direita_lateral" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_direita_lateral') }}</label>
                            </div>
                            @if($errors->has('lateral_direita_lateral'))
                                <span class="help-block" role="alert">{{ $errors->first('lateral_direita_lateral') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_direita_lateral_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('lateral_direita_porta_tras') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="lateral_direita_porta_tras" id="lateral_direita_porta_tras" value="1" {{ $registoEntradaVeiculo->lateral_direita_porta_tras || old('lateral_direita_porta_tras', 0) === 1 ? 'checked' : '' }}>
                                <label for="lateral_direita_porta_tras" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_direita_porta_tras') }}</label>
                            </div>
                            @if($errors->has('lateral_direita_porta_tras'))
                                <span class="help-block" role="alert">{{ $errors->first('lateral_direita_porta_tras') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_direita_porta_tras_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('lateral_direita_porta_diant') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="lateral_direita_porta_diant" id="lateral_direita_porta_diant" value="1" {{ $registoEntradaVeiculo->lateral_direita_porta_diant || old('lateral_direita_porta_diant', 0) === 1 ? 'checked' : '' }}>
                                <label for="lateral_direita_porta_diant" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_direita_porta_diant') }}</label>
                            </div>
                            @if($errors->has('lateral_direita_porta_diant'))
                                <span class="help-block" role="alert">{{ $errors->first('lateral_direita_porta_diant') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_direita_porta_diant_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('lateral_direita_retrovisor') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="lateral_direita_retrovisor" id="lateral_direita_retrovisor" value="1" {{ $registoEntradaVeiculo->lateral_direita_retrovisor || old('lateral_direita_retrovisor', 0) === 1 ? 'checked' : '' }}>
                                <label for="lateral_direita_retrovisor" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_direita_retrovisor') }}</label>
                            </div>
                            @if($errors->has('lateral_direita_retrovisor'))
                                <span class="help-block" role="alert">{{ $errors->first('lateral_direita_retrovisor') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_direita_retrovisor_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('lateral_direita_paralama_diant') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="lateral_direita_paralama_diant" id="lateral_direita_paralama_diant" value="1" {{ $registoEntradaVeiculo->lateral_direita_paralama_diant || old('lateral_direita_paralama_diant', 0) === 1 ? 'checked' : '' }}>
                                <label for="lateral_direita_paralama_diant" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_direita_paralama_diant') }}</label>
                            </div>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_direita_paralama_diant_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('lateral_direita_nada_consta') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="lateral_direita_nada_consta" id="lateral_direita_nada_consta" value="1" {{ $registoEntradaVeiculo->lateral_direita_nada_consta || old('lateral_direita_nada_consta', 0) === 1 ? 'checked' : '' }}>
                                <label for="lateral_direita_nada_consta" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_direita_nada_consta') }}</label>
                            </div>
                            @if($errors->has('lateral_direita_nada_consta'))
                                <span class="help-block" role="alert">{{ $errors->first('lateral_direita_nada_consta') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_direita_nada_consta_helper') }}</span>
                        </div>
                        ...
                        <div class="form-group {{ $errors->has('lateral_direita_obs') ? 'has-error' : '' }}">
                            <label for="lateral_direita_obs">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_direita_obs') }}</label>
                            <textarea class="form-control" name="lateral_direita_obs" id="lateral_direita_obs">{{ old('lateral_direita_obs', $registoEntradaVeiculo->lateral_direita_obs) }}</textarea>
                            @if($errors->has('lateral_direita_obs'))
                                <span class="help-block" role="alert">{{ $errors->first('lateral_direita_obs') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.lateral_direita_obs_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('cinzeiro_sim') ? 'has-error' : '' }}">
                            <div>
                                <input type="hidden" name="cinzeiro_sim" value="0">
                                <input type="checkbox" name="cinzeiro_sim" id="cinzeiro_sim" value="1" {{ $registoEntradaVeiculo->cinzeiro_sim || old('cinzeiro_sim', 0) === 1 ? 'checked' : '' }}>
                                <label for="cinzeiro_sim" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.cinzeiro_sim') }}</label>
                            </div>
                            @if($errors->has('cinzeiro_sim'))
                                <span class="help-block" role="alert">{{ $errors->first('cinzeiro_sim') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.cinzeiro_sim_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('cinzeiro_nada_consta') ? 'has-error' : '' }}">
                            <div>
                                <input type="hidden" name="cinzeiro_nada_consta" value="0">
                                <input type="checkbox" name="cinzeiro_nada_consta" id="cinzeiro_nada_consta" value="1" {{ $registoEntradaVeiculo->cinzeiro_nada_consta || old('cinzeiro_nada_consta', 0) === 1 ? 'checked' : '' }}>
                                <label for="cinzeiro_nada_consta" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.cinzeiro_nada_consta') }}</label>
                            </div>
                            @if($errors->has('cinzeiro_nada_consta'))
                                <span class="help-block" role="alert">{{ $errors->first('cinzeiro_nada_consta') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.cinzeiro_nada_consta_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('cinzeiro_photos') ? 'has-error' : '' }}">
                            <label for="cinzeiro_photos">{{ trans('cruds.registoEntradaVeiculo.fields.cinzeiro_photos') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.cinzeiro_photos_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('aspiracao_bancos_frente') ? 'has-error' : '' }}">
                            <div>
                                <input type="hidden" name="aspiracao_bancos_frente" value="0">
                                <input type="checkbox" name="aspiracao_bancos_frente" id="aspiracao_bancos_frente" value="1" {{ $registoEntradaVeiculo->aspiracao_bancos_frente || old('aspiracao_bancos_frente', 0) === 1 ? 'checked' : '' }}>
                                <label for="aspiracao_bancos_frente" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.aspiracao_bancos_frente') }}</label>
                            </div>
                            @if($errors->has('aspiracao_bancos_frente'))
                                <span class="help-block" role="alert">{{ $errors->first('aspiracao_bancos_frente') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.aspiracao_bancos_frente_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('aspiracao_bancos_tras') ? 'has-error' : '' }}">
                            <div>
                                <input type="hidden" name="aspiracao_bancos_tras" value="0">
                                <input type="checkbox" name="aspiracao_bancos_tras" id="aspiracao_bancos_tras" value="1" {{ $registoEntradaVeiculo->aspiracao_bancos_tras || old('aspiracao_bancos_tras', 0) === 1 ? 'checked' : '' }}>
                                <label for="aspiracao_bancos_tras" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.aspiracao_bancos_tras') }}</label>
                            </div>
                            @if($errors->has('aspiracao_bancos_tras'))
                                <span class="help-block" role="alert">{{ $errors->first('aspiracao_bancos_tras') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.aspiracao_bancos_tras_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('aspiracao_tapetes_e_chao_frente') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="aspiracao_tapetes_e_chao_frente" id="aspiracao_tapetes_e_chao_frente" value="1" {{ $registoEntradaVeiculo->aspiracao_tapetes_e_chao_frente || old('aspiracao_tapetes_e_chao_frente', 0) === 1 ? 'checked' : '' }}>
                                <label for="aspiracao_tapetes_e_chao_frente" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.aspiracao_tapetes_e_chao_frente') }}</label>
                            </div>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.aspiracao_tapetes_e_chao_frente_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('aspiracao_tapetes_e_chao_tras') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="aspiracao_tapetes_e_chao_tras" id="aspiracao_tapetes_e_chao_tras" value="1" {{ $registoEntradaVeiculo->aspiracao_tapetes_e_chao_tras || old('aspiracao_tapetes_e_chao_tras', 0) === 1 ? 'checked' : '' }}>
                                <label for="aspiracao_tapetes_e_chao_tras" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.aspiracao_tapetes_e_chao_tras') }}</label>
                            </div>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.aspiracao_tapetes_e_chao_tras_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('limpeza_e_brilho_de_plasticos_carro') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="limpeza_e_brilho_de_plasticos_carro" id="limpeza_e_brilho_de_plasticos_carro" value="1" {{ $registoEntradaVeiculo->limpeza_e_brilho_de_plasticos_carro || old('limpeza_e_brilho_de_plasticos_carro', 0) === 1 ? 'checked' : '' }}>
                                <label for="limpeza_e_brilho_de_plasticos_carro" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.limpeza_e_brilho_de_plasticos_carro') }}</label>
                            </div>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.limpeza_e_brilho_de_plasticos_carro_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('ambientador_de_carro') ? 'has-error' : '' }}">
                            <div>
                                <input type="hidden" name="ambientador_de_carro" value="0">
                                <input type="checkbox" name="ambientador_de_carro" id="ambientador_de_carro" value="1" {{ $registoEntradaVeiculo->ambientador_de_carro || old('ambientador_de_carro', 0) === 1 ? 'checked' : '' }}>
                                <label for="ambientador_de_carro" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.ambientador_de_carro') }}</label>
                            </div>
                            @if($errors->has('ambientador_de_carro'))
                                <span class="help-block" role="alert">{{ $errors->first('ambientador_de_carro') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.ambientador_de_carro_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('limpeza_vidros_interiores') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="limpeza_vidros_interiores" id="limpeza_vidros_interiores" value="1" {{ $registoEntradaVeiculo->limpeza_vidros_interiores || old('limpeza_vidros_interiores', 0) === 1 ? 'checked' : '' }}>
                                <label for="limpeza_vidros_interiores" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.limpeza_vidros_interiores') }}</label>
                            </div>
                            @if($errors->has('limpeza_vidros_interiores'))
                                <span class="help-block" role="alert">{{ $errors->first('limpeza_vidros_interiores') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.limpeza_vidros_interiores_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('retirar_os_objetos_pessoais_existentes_no_carro') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="retirar_os_objetos_pessoais_existentes_no_carro" id="retirar_os_objetos_pessoais_existentes_no_carro" value="1" {{ $registoEntradaVeiculo->retirar_os_objetos_pessoais_existentes_no_carro || old('retirar_os_objetos_pessoais_existentes_no_carro', 0) === 1 ? 'checked' : '' }}>
                                <label for="retirar_os_objetos_pessoais_existentes_no_carro" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.retirar_os_objetos_pessoais_existentes_no_carro') }}</label>
                            </div>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.retirar_os_objetos_pessoais_existentes_no_carro_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('verificacao_de_luzes_no_painel') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="verificacao_de_luzes_no_painel" id="verificacao_de_luzes_no_painel" value="1" {{ $registoEntradaVeiculo->verificacao_de_luzes_no_painel || old('verificacao_de_luzes_no_painel', 0) === 1 ? 'checked' : '' }}>
                                <label for="verificacao_de_luzes_no_painel" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.verificacao_de_luzes_no_painel') }}</label>
                            </div>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.verificacao_de_luzes_no_painel_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('verificacao_de_necessidade_de_lavagem_estofos') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="verificacao_de_necessidade_de_lavagem_estofos" id="verificacao_de_necessidade_de_lavagem_estofos" value="1" {{ $registoEntradaVeiculo->verificacao_de_necessidade_de_lavagem_estofos || old('verificacao_de_necessidade_de_lavagem_estofos', 0) === 1 ? 'checked' : '' }}>
                                <label for="verificacao_de_necessidade_de_lavagem_estofos" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.verificacao_de_necessidade_de_lavagem_estofos') }}</label>
                            </div>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.verificacao_de_necessidade_de_lavagem_estofos_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('check_list_aspiracao_obs') ? 'has-error' : '' }}">
                            <label for="check_list_aspiracao_obs">{{ trans('cruds.registoEntradaVeiculo.fields.check_list_aspiracao_obs') }}</label>
                            <textarea class="form-control" name="check_list_aspiracao_obs" id="check_list_aspiracao_obs">{{ old('check_list_aspiracao_obs', $registoEntradaVeiculo->check_list_aspiracao_obs) }}</textarea>
                            @if($errors->has('check_list_aspiracao_obs'))
                                <span class="help-block" role="alert">{{ $errors->first('check_list_aspiracao_obs') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.check_list_aspiracao_obs_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('copia_de_licenca_de_tvde') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="copia_de_licenca_de_tvde" id="copia_de_licenca_de_tvde" value="1" {{ $registoEntradaVeiculo->copia_de_licenca_de_tvde || old('copia_de_licenca_de_tvde', 0) === 1 ? 'checked' : '' }}>
                                <label for="copia_de_licenca_de_tvde" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.copia_de_licenca_de_tvde') }}</label>
                            </div>
                            @if($errors->has('copia_de_licenca_de_tvde'))
                                <span class="help-block" role="alert">{{ $errors->first('copia_de_licenca_de_tvde') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.copia_de_licenca_de_tvde_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('copia_de_licenca_de_tvde_data') ? 'has-error' : '' }}">
                            <label for="copia_de_licenca_de_tvde_data">{{ trans('cruds.registoEntradaVeiculo.fields.copia_de_licenca_de_tvde_data') }}</label>
                            <input class="form-control date" type="text" name="copia_de_licenca_de_tvde_data" id="copia_de_licenca_de_tvde_data" value="{{ old('copia_de_licenca_de_tvde_data', $registoEntradaVeiculo->copia_de_licenca_de_tvde_data) }}">
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.copia_de_licenca_de_tvde_data_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('copia_de_licenca_de_tvde_comentarios') ? 'has-error' : '' }}">
                            <label for="copia_de_licenca_de_tvde_comentarios">{{ trans('cruds.registoEntradaVeiculo.fields.copia_de_licenca_de_tvde_comentarios') }}</label>
                            <input class="form-control" type="text" name="copia_de_licenca_de_tvde_comentarios" id="copia_de_licenca_de_tvde_comentarios" value="{{ old('copia_de_licenca_de_tvde_comentarios', $registoEntradaVeiculo->copia_de_licenca_de_tvde_comentarios) }}">
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.copia_de_licenca_de_tvde_comentarios_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('carta_verde_de_seguro_validade') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="carta_verde_de_seguro_validade" id="carta_verde_de_seguro_validade" value="1" {{ $registoEntradaVeiculo->carta_verde_de_seguro_validade || old('carta_verde_de_seguro_validade', 0) === 1 ? 'checked' : '' }}>
                                <label for="carta_verde_de_seguro_validade" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.carta_verde_de_seguro_validade') }}</label>
                            </div>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.carta_verde_de_seguro_validade_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('carta_verde_de_seguro_validade_data') ? 'has-error' : '' }}">
                            <label for="carta_verde_de_seguro_validade_data">{{ trans('cruds.registoEntradaVeiculo.fields.carta_verde_de_seguro_validade_data') }}</label>
                            <input class="form-control date" type="text" name="carta_verde_de_seguro_validade_data" id="carta_verde_de_seguro_validade_data" value="{{ old('carta_verde_de_seguro_validade_data', $registoEntradaVeiculo->carta_verde_de_seguro_validade_data) }}">
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.carta_verde_de_seguro_validade_data_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('carta_verde_de_seguro_validade_comentarios') ? 'has-error' : '' }}">
                            <label for="carta_verde_de_seguro_validade_comentarios">{{ trans('cruds.registoEntradaVeiculo.fields.carta_verde_de_seguro_validade_comentarios') }}</label>
                            <input class="form-control" type="text" name="carta_verde_de_seguro_validade_comentarios" id="carta_verde_de_seguro_validade_comentarios" value="{{ old('carta_verde_de_seguro_validade_comentarios', $registoEntradaVeiculo->carta_verde_de_seguro_validade_comentarios) }}">
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.carta_verde_de_seguro_validade_comentarios_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('dua_do_veiculo') ? 'has-error' : '' }}">
                            <div>
                                <input type="hidden" name="dua_do_veiculo" value="0">
                                <input type="checkbox" name="dua_do_veiculo" id="dua_do_veiculo" value="1" {{ $registoEntradaVeiculo->dua_do_veiculo || old('dua_do_veiculo', 0) === 1 ? 'checked' : '' }}>
                                <label for="dua_do_veiculo" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.dua_do_veiculo') }}</label>
                            </div>
                            @if($errors->has('dua_do_veiculo'))
                                <span class="help-block" role="alert">{{ $errors->first('dua_do_veiculo') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.dua_do_veiculo_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('dua_do_veiculo_data') ? 'has-error' : '' }}">
                            <label for="dua_do_veiculo_data">{{ trans('cruds.registoEntradaVeiculo.fields.dua_do_veiculo_data') }}</label>
                            <input class="form-control date" type="text" name="dua_do_veiculo_data" id="dua_do_veiculo_data" value="{{ old('dua_do_veiculo_data', $registoEntradaVeiculo->dua_do_veiculo_data) }}">
                            @if($errors->has('dua_do_veiculo_data'))
                                <span class="help-block" role="alert">{{ $errors->first('dua_do_veiculo_data') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.dua_do_veiculo_data_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('dua_do_veiculo_comentarios') ? 'has-error' : '' }}">
                            <label for="dua_do_veiculo_comentarios">{{ trans('cruds.registoEntradaVeiculo.fields.dua_do_veiculo_comentarios') }}</label>
                            <input class="form-control" type="text" name="dua_do_veiculo_comentarios" id="dua_do_veiculo_comentarios" value="{{ old('dua_do_veiculo_comentarios', $registoEntradaVeiculo->dua_do_veiculo_comentarios) }}">
                            @if($errors->has('dua_do_veiculo_comentarios'))
                                <span class="help-block" role="alert">{{ $errors->first('dua_do_veiculo_comentarios') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.dua_do_veiculo_comentarios_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('inspecao_do_veiculo_validade') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="inspecao_do_veiculo_validade" id="inspecao_do_veiculo_validade" value="1" {{ $registoEntradaVeiculo->inspecao_do_veiculo_validade || old('inspecao_do_veiculo_validade', 0) === 1 ? 'checked' : '' }}>
                                <label for="inspecao_do_veiculo_validade" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.inspecao_do_veiculo_validade') }}</label>
                            </div>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.inspecao_do_veiculo_validade_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('inspecao_do_veiculo_validade_data') ? 'has-error' : '' }}">
                            <label for="inspecao_do_veiculo_validade_data">{{ trans('cruds.registoEntradaVeiculo.fields.inspecao_do_veiculo_validade_data') }}</label>
                            <input class="form-control date" type="text" name="inspecao_do_veiculo_validade_data" id="inspecao_do_veiculo_validade_data" value="{{ old('inspecao_do_veiculo_validade_data', $registoEntradaVeiculo->inspecao_do_veiculo_validade_data) }}">
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.inspecao_do_veiculo_validade_data_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('inspecao_do_veiculo_validade_comentarios') ? 'has-error' : '' }}">
                            <label for="inspecao_do_veiculo_validade_comentarios">{{ trans('cruds.registoEntradaVeiculo.fields.inspecao_do_veiculo_validade_comentarios') }}</label>
                            <input class="form-control" type="text" name="inspecao_do_veiculo_validade_comentarios" id="inspecao_do_veiculo_validade_comentarios" value="{{ old('inspecao_do_veiculo_validade_comentarios', $registoEntradaVeiculo->inspecao_do_veiculo_validade_comentarios) }}">
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.inspecao_do_veiculo_validade_comentarios_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('contratro_de_prestacao_de_servicos') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="contratro_de_prestacao_de_servicos" id="contratro_de_prestacao_de_servicos" value="1" {{ $registoEntradaVeiculo->contratro_de_prestacao_de_servicos || old('contratro_de_prestacao_de_servicos', 0) === 1 ? 'checked' : '' }}>
                                <label for="contratro_de_prestacao_de_servicos" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.contratro_de_prestacao_de_servicos') }}</label>
                            </div>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.contratro_de_prestacao_de_servicos_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('contratro_de_prestacao_de_servicos_data') ? 'has-error' : '' }}">
                            <label for="contratro_de_prestacao_de_servicos_data">{{ trans('cruds.registoEntradaVeiculo.fields.contratro_de_prestacao_de_servicos_data') }}</label>
                            <input class="form-control date" type="text" name="contratro_de_prestacao_de_servicos_data" id="contratro_de_prestacao_de_servicos_data" value="{{ old('contratro_de_prestacao_de_servicos_data', $registoEntradaVeiculo->contratro_de_prestacao_de_servicos_data) }}">
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.contratro_de_prestacao_de_servicos_data_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('contratro_de_prestacao_de_servicos_comentarios') ? 'has-error' : '' }}">
                            <label for="contratro_de_prestacao_de_servicos_comentarios">{{ trans('cruds.registoEntradaVeiculo.fields.contratro_de_prestacao_de_servicos_comentarios') }}</label>
                            <input class="form-control" type="text" name="contratro_de_prestacao_de_servicos_comentarios" id="contratro_de_prestacao_de_servicos_comentarios" value="{{ old('contratro_de_prestacao_de_servicos_comentarios', $registoEntradaVeiculo->contratro_de_prestacao_de_servicos_comentarios) }}">
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.contratro_de_prestacao_de_servicos_comentarios_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('distico_tvde_colocado') ? 'has-error' : '' }}">
                            <div>
                                <input type="hidden" name="distico_tvde_colocado" value="0">
                                <input type="checkbox" name="distico_tvde_colocado" id="distico_tvde_colocado" value="1" {{ $registoEntradaVeiculo->distico_tvde_colocado || old('distico_tvde_colocado', 0) === 1 ? 'checked' : '' }}>
                                <label for="distico_tvde_colocado" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.distico_tvde_colocado') }}</label>
                            </div>
                            @if($errors->has('distico_tvde_colocado'))
                                <span class="help-block" role="alert">{{ $errors->first('distico_tvde_colocado') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.distico_tvde_colocado_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('distico_tvde_colocado_data') ? 'has-error' : '' }}">
                            <label for="distico_tvde_colocado_data">{{ trans('cruds.registoEntradaVeiculo.fields.distico_tvde_colocado_data') }}</label>
                            <input class="form-control date" type="text" name="distico_tvde_colocado_data" id="distico_tvde_colocado_data" value="{{ old('distico_tvde_colocado_data', $registoEntradaVeiculo->distico_tvde_colocado_data) }}">
                            @if($errors->has('distico_tvde_colocado_data'))
                                <span class="help-block" role="alert">{{ $errors->first('distico_tvde_colocado_data') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.distico_tvde_colocado_data_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('distico_tvde_colocado_comentarios') ? 'has-error' : '' }}">
                            <label for="distico_tvde_colocado_comentarios">{{ trans('cruds.registoEntradaVeiculo.fields.distico_tvde_colocado_comentarios') }}</label>
                            <input class="form-control" type="text" name="distico_tvde_colocado_comentarios" id="distico_tvde_colocado_comentarios" value="{{ old('distico_tvde_colocado_comentarios', $registoEntradaVeiculo->distico_tvde_colocado_comentarios) }}">
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.distico_tvde_colocado_comentarios_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('declaracao_amigavel') ? 'has-error' : '' }}">
                            <div>
                                <input type="hidden" name="declaracao_amigavel" value="0">
                                <input type="checkbox" name="declaracao_amigavel" id="declaracao_amigavel" value="1" {{ $registoEntradaVeiculo->declaracao_amigavel || old('declaracao_amigavel', 0) === 1 ? 'checked' : '' }}>
                                <label for="declaracao_amigavel" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.declaracao_amigavel') }}</label>
                            </div>
                            @if($errors->has('declaracao_amigavel'))
                                <span class="help-block" role="alert">{{ $errors->first('declaracao_amigavel') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.declaracao_amigavel_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('declaracao_amigavel_data') ? 'has-error' : '' }}">
                            <label for="declaracao_amigavel_data">{{ trans('cruds.registoEntradaVeiculo.fields.declaracao_amigavel_data') }}</label>
                            <input class="form-control date" type="text" name="declaracao_amigavel_data" id="declaracao_amigavel_data" value="{{ old('declaracao_amigavel_data', $registoEntradaVeiculo->declaracao_amigavel_data) }}">
                            @if($errors->has('declaracao_amigavel_data'))
                                <span class="help-block" role="alert">{{ $errors->first('declaracao_amigavel_data') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.declaracao_amigavel_data_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('declaracao_amigavel_comentarios') ? 'has-error' : '' }}">
                            <label for="declaracao_amigavel_comentarios">{{ trans('cruds.registoEntradaVeiculo.fields.declaracao_amigavel_comentarios') }}</label>
                            <input class="form-control" type="text" name="declaracao_amigavel_comentarios" id="declaracao_amigavel_comentarios" value="{{ old('declaracao_amigavel_comentarios', $registoEntradaVeiculo->declaracao_amigavel_comentarios) }}">
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.declaracao_amigavel_comentarios_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('aplicacao_de_agua_por_todo_o_carro') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="aplicacao_de_agua_por_todo_o_carro" id="aplicacao_de_agua_por_todo_o_carro" value="1" {{ $registoEntradaVeiculo->aplicacao_de_agua_por_todo_o_carro || old('aplicacao_de_agua_por_todo_o_carro', 0) === 1 ? 'checked' : '' }}>
                                <label for="aplicacao_de_agua_por_todo_o_carro" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.aplicacao_de_agua_por_todo_o_carro') }}</label>
                            </div>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.aplicacao_de_agua_por_todo_o_carro_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('passagem_de_agua_em_todo_o_carro') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="passagem_de_agua_em_todo_o_carro" id="passagem_de_agua_em_todo_o_carro" value="1" {{ $registoEntradaVeiculo->passagem_de_agua_em_todo_o_carro || old('passagem_de_agua_em_todo_o_carro', 0) === 1 ? 'checked' : '' }}>
                                <label for="passagem_de_agua_em_todo_o_carro" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.passagem_de_agua_em_todo_o_carro') }}</label>
                            </div>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.passagem_de_agua_em_todo_o_carro_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('aplicacao_de_champo_em_todo_o_carro') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="aplicacao_de_champo_em_todo_o_carro" id="aplicacao_de_champo_em_todo_o_carro" value="1" {{ $registoEntradaVeiculo->aplicacao_de_champo_em_todo_o_carro || old('aplicacao_de_champo_em_todo_o_carro', 0) === 1 ? 'checked' : '' }}>
                                <label for="aplicacao_de_champo_em_todo_o_carro" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.aplicacao_de_champo_em_todo_o_carro') }}</label>
                            </div>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.aplicacao_de_champo_em_todo_o_carro_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('esfregar_todo_o_carro_com_a_escova') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="esfregar_todo_o_carro_com_a_escova" id="esfregar_todo_o_carro_com_a_escova" value="1" {{ $registoEntradaVeiculo->esfregar_todo_o_carro_com_a_escova || old('esfregar_todo_o_carro_com_a_escova', 0) === 1 ? 'checked' : '' }}>
                                <label for="esfregar_todo_o_carro_com_a_escova" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.esfregar_todo_o_carro_com_a_escova') }}</label>
                            </div>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.esfregar_todo_o_carro_com_a_escova_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('retirar_com_agua') ? 'has-error' : '' }}">
                            <div>
                                <input type="hidden" name="retirar_com_agua" value="0">
                                <input type="checkbox" name="retirar_com_agua" id="retirar_com_agua" value="1" {{ $registoEntradaVeiculo->retirar_com_agua || old('retirar_com_agua', 0) === 1 ? 'checked' : '' }}>
                                <label for="retirar_com_agua" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.retirar_com_agua') }}</label>
                            </div>
                            @if($errors->has('retirar_com_agua'))
                                <span class="help-block" role="alert">{{ $errors->first('retirar_com_agua') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.retirar_com_agua_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('verificar_sujidades_ainda_existentes') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="verificar_sujidades_ainda_existentes" id="verificar_sujidades_ainda_existentes" value="1" {{ $registoEntradaVeiculo->verificar_sujidades_ainda_existentes || old('verificar_sujidades_ainda_existentes', 0) === 1 ? 'checked' : '' }}>
                                <label for="verificar_sujidades_ainda_existentes" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.verificar_sujidades_ainda_existentes') }}</label>
                            </div>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.verificar_sujidades_ainda_existentes_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('limpeza_de_jantes') ? 'has-error' : '' }}">
                            <div>
                                <input type="hidden" name="limpeza_de_jantes" value="0">
                                <input type="checkbox" name="limpeza_de_jantes" id="limpeza_de_jantes" value="1" {{ $registoEntradaVeiculo->limpeza_de_jantes || old('limpeza_de_jantes', 0) === 1 ? 'checked' : '' }}>
                                <label for="limpeza_de_jantes" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.limpeza_de_jantes') }}</label>
                            </div>
                            @if($errors->has('limpeza_de_jantes'))
                                <span class="help-block" role="alert">{{ $errors->first('limpeza_de_jantes') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.limpeza_de_jantes_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('possui_triangulo') ? 'has-error' : '' }}">
                            <label for="possui_triangulo">{{ trans('cruds.registoEntradaVeiculo.fields.possui_triangulo') }}</label>
                            <input class="form-control" type="text" name="possui_triangulo" id="possui_triangulo" value="{{ old('possui_triangulo', $registoEntradaVeiculo->possui_triangulo) }}">
                            @if($errors->has('possui_triangulo'))
                                <span class="help-block" role="alert">{{ $errors->first('possui_triangulo') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.possui_triangulo_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('possui_extintor') ? 'has-error' : '' }}">
                            <div>
                                <input type="hidden" name="possui_extintor" value="0">
                                <input type="checkbox" name="possui_extintor" id="possui_extintor" value="1" {{ $registoEntradaVeiculo->possui_extintor || old('possui_extintor', 0) === 1 ? 'checked' : '' }}>
                                <label for="possui_extintor" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.possui_extintor') }}</label>
                            </div>
                            @if($errors->has('possui_extintor'))
                                <span class="help-block" role="alert">{{ $errors->first('possui_extintor') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.possui_extintor_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('banco_elevatorio_crianca') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="banco_elevatorio_crianca" id="banco_elevatorio_crianca" value="1" {{ $registoEntradaVeiculo->banco_elevatorio_crianca || old('banco_elevatorio_crianca', 0) === 1 ? 'checked' : '' }}>
                                <label for="banco_elevatorio_crianca" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.banco_elevatorio_crianca') }}</label>
                            </div>
                            @if($errors->has('banco_elevatorio_crianca'))
                                <span class="help-block" role="alert">{{ $errors->first('banco_elevatorio_crianca') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.banco_elevatorio_crianca_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('colete') ? 'has-error' : '' }}">
                            <div>
                                <input type="hidden" name="colete" value="0">
                                <input type="checkbox" name="colete" id="colete" value="1" {{ $registoEntradaVeiculo->colete || old('colete', 0) === 1 ? 'checked' : '' }}>
                                <label for="colete" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.colete') }}</label>
                            </div>
                            @if($errors->has('colete'))
                                <span class="help-block" role="alert">{{ $errors->first('colete') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.colete_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('tratado') ? 'has-error' : '' }}">
                            <div>
                                <input type="hidden" name="tratado" value="0">
                                <input type="checkbox" name="tratado" id="tratado" value="1" {{ $registoEntradaVeiculo->tratado || old('tratado', 0) === 1 ? 'checked' : '' }}>
                                <label for="tratado" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.tratado') }}</label>
                            </div>
                            @if($errors->has('tratado'))
                                <span class="help-block" role="alert">{{ $errors->first('tratado') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.tratado_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('comentarios') ? 'has-error' : '' }}">
                            <label for="comentarios">{{ trans('cruds.registoEntradaVeiculo.fields.comentarios') }}</label>
                            <textarea class="form-control" name="comentarios" id="comentarios">{{ old('comentarios', $registoEntradaVeiculo->comentarios) }}</textarea>
                            @if($errors->has('comentarios'))
                                <span class="help-block" role="alert">{{ $errors->first('comentarios') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.comentarios_helper') }}</span>
                        </div>
                        <div class="form-group {{ $errors->has('reparado') ? 'has-error' : '' }}">
                            <div>
                                <input type="hidden" name="reparado" value="0">
                                <input type="checkbox" name="reparado" id="reparado" value="1" {{ $registoEntradaVeiculo->reparado || old('reparado', 0) === 1 ? 'checked' : '' }}>
                                <label for="reparado" style="font-weight: 400">{{ trans('cruds.registoEntradaVeiculo.fields.reparado') }}</label>
                            </div>
                            @if($errors->has('reparado'))
                                <span class="help-block" role="alert">{{ $errors->first('reparado') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.registoEntradaVeiculo.fields.reparado_helper') }}</span>
                        </div>
