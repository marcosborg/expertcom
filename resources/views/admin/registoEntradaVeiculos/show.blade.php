                        ...
                        <table class="table table-bordered table-striped">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" disabled="disabled" {{ $registoEntradaVeiculo->frente_teto ? 'checked' : '' }}>
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                    ...
                                    <td>
                                        <input type="checkbox" disabled="disabled" {{ $registoEntradaVeiculo->frente_parabrisa ? 'checked' : '' }}>
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                    ...
                                    <td>
                                        <input type="checkbox" disabled="disabled" {{ $registoEntradaVeiculo->frente_capo ? 'checked' : '' }}>
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                    ...
                                    <td>
                                        <input type="checkbox" disabled="disabled" {{ $registoEntradaVeiculo->frente_parachoque ? 'checked' : '' }}>
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                    ...
                                    <td>
                                        <input type="checkbox" disabled="disabled" {{ $registoEntradaVeiculo->frente_nada_consta ? 'checked' : '' }}>
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                    ...
                                    <td>
                                        @foreach($registoEntradaVeiculo->frente_teto_photos as $key => $media)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @foreach($registoEntradaVeiculo->frente_parabrisa_photos as $key => $media)
                                            <a href="{{ $media->getUrl() }}" target="_blank" style="display: inline-block">
                                                <img src="{{ $media->getUrl('thumb') }}">
                                            </a>
                                        @endforeach
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @foreach($registoEntradaVeiculo->frente_capo_photos as $key => $media)
                                            <a href="{{ $media->getUrl() }}" target="_blank" style="display: inline-block">
                                                <img src="{{ $media->getUrl('thumb') }}">
                                            </a>
                                        @endforeach
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @foreach($registoEntradaVeiculo->frente_parachoque_photos as $key => $media)
                                            <a href="{{ $media->getUrl() }}" target="_blank" style="display: inline-block">
                                                <img src="{{ $media->getUrl('thumb') }}">
                                            </a>
                                        @endforeach
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ $registoEntradaVeiculo->frente_obs }}
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" disabled="disabled" {{ $registoEntradaVeiculo->lateral_esquerda_porta_dianteira ? 'checked' : '' }}>
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                    ...
                                    <td>
                                        <input type="checkbox" disabled="disabled" {{ $registoEntradaVeiculo->lateral_esquerda_porta_traseira ? 'checked' : '' }}>
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @foreach($registoEntradaVeiculo->lateral_esquerda_porta_dianteira_photos as $key => $media)
                                            <a href="{{ $media->getUrl() }}" target="_blank" style="display: inline-block">
                                                <img src="{{ $media->getUrl('thumb') }}">
                                            </a>
                                        @endforeach
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @foreach($registoEntradaVeiculo->lateral_esquerda_porta_traseira_photos as $key => $media)
                                            <a href="{{ $media->getUrl() }}" target="_blank" style="display: inline-block">
                                                <img src="{{ $media->getUrl('thumb') }}">
                                            </a>
                                        @endforeach
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" disabled="disabled" {{ $registoEntradaVeiculo->traseira_farol_direito ? 'checked' : '' }}>
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                    ...
                                    <td>
                                        <input type="checkbox" disabled="disabled" {{ $registoEntradaVeiculo->traseira_farol_esquerdo ? 'checked' : '' }}>
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                    ...
                                    <td>
                                        <input type="checkbox" disabled="disabled" {{ $registoEntradaVeiculo->traseira_parachoque_traseiro ? 'checked' : '' }}>
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                ...
                                <tr>
                                    <th>
                                        {{ trans('cruds.registoEntradaVeiculo.fields.cinzeiro') }}
                                    </th>
                                    <td>
                                        @foreach($registoEntradaVeiculo->cinzeiro as $key => $media)
                                            <a href="{{ $media->getUrl() }}" target="_blank" style="display: inline-block">
                                                <img src="{{ $media->getUrl('thumb') }}">
                                            </a>
                                        @endforeach
                                ...
                                <tr>
                                    <th>
                                        {{ trans('cruds.registoEntradaVeiculo.fields.aspiracao_obs') }}
                                    </th>
                                    <td>
                                        {{ $registoEntradaVeiculo->aspiracao_obs }}
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ $registoEntradaVeiculo->carta_verde_de_seguro_data }}
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                    ...
                                    <td>
                                        {{ $registoEntradaVeiculo->carta_verde_de_seguro_comentarios }}
                                    </td>
                                </tr>
                                <tr>
                                    <th>
