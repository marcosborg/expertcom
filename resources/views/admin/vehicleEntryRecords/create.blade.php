        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.vehicleEntryRecord.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.vehicle-entry-records.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('battery_enter') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="battery_enter" id="battery_enter" value="{{ old('battery_enter', '') }}" step="1" required>
                        ...
                        <div class="form-group {{ $errors->has('battery_exit') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="battery_exit" id="battery_exit" value="{{ old('battery_exit', '') }}" step="1" required>
                        ...
                        <div class="form-group {{ $errors->has('quilometers') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="quilometers" id="quilometers" value="{{ old('quilometers', '') }}" step="1" required>
