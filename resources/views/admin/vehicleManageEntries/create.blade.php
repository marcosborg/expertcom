...
<div class="content">
    ...
    <div class="row">
        <div class="col-md-3">
            <form method="POST" action="{{ route("admin.vehicle-manage-entries.store") }}" enctype="multipart/form-data">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        {{ trans('global.create') }} {{ trans('cruds.vehicleManageEntry.title_singular') }}
                    </div>
