...
@section('content')
<div class="content">
    @can('vehicle_manage_entry_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.vehicle-manage-entries.create') }}">
                    {{ trans('global.add') }} {{ trans('cruds.vehicleManageEntry.title_singular') }}
                </a>
            </div>
        </div>
    @endcan
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('cruds.vehicleManageEntry.title_singular') }} {{ trans('global.list') }}
                </div>
                <div class="panel-body">
                    <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-VehicleManageEntry">
                        <thead>
                            <tr>
                                <th width="10">
...
@can('vehicle_manage_entry_delete')
  let deleteButtonTrans = '{{ trans('global.datatables.delete') }}';
  let deleteButton = {
    text: deleteButtonTrans,
    url: "{{ route('admin.vehicle-manage-entries.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.vehicle-manage-entries.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-VehicleManageEntry').DataTable(dtOverrideGlobals);
