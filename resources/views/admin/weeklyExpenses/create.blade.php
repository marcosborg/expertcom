        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.weeklyExpense.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.weekly-expenses.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('expenses') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="expenses" id="expenses" required>{{ old('expenses') }}</textarea>
