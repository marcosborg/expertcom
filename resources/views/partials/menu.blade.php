<aside class="main-sidebar">
    <section class="sidebar" style="height: auto;">
        <ul class="sidebar-menu tree" data-widget="tree">
            ...
            @endcan
            @can('vehicle_manage_access')
                <li class="treeview">
                    <a href="#">
                        <i class="fa-fw fas fa-car">

                        </i>
                        <span>{{ trans('cruds.vehicleManage.title') }}</span>
                        <span class="pull-right-container"><i class="fa fa-fw fa-angle-left pull-right"></i></span>
                    </a>
                    <ul class="treeview-menu">
                        @can('vehicle_manage_entry_access')
                            <li class="{{ request()->is("admin/vehicle-manage-entries") || request()->is("admin/vehicle-manage-entries/*") ? "active" : "" }}">
                                <a href="{{ route("admin.vehicle-manage-entries.index") }}">
                                    <i class="fa-fw fas fa-plus">

                                    </i>
                                    <span>{{ trans('cruds.vehicleManageEntry.title') }}</span>
                        ...
                        @can('vehicle_manage_checkin_access')
                            <li class="{{ request()->is("admin/vehicle-manage-checkins") || request()->is("admin/vehicle-manage-checkins/*") ? "active" : "" }}">
                                <a href="{{ route("admin.vehicle-manage-checkins.index", 'reparado=0') }}">
                                    ...
                                    <span>{{ trans('cruds.vehicleManageCheckin.title') }}</span>

                                </a>
                            </li>
                        @endcan
                        @can('vehicle_manage_delivery_access')
                            <li class="{{ request()->is("admin/vehicle-manage-deliveries") || request()->is("admin/vehicle-manage-deliveries/*") ? "active" : "" }}">
                                <a href="{{ route("admin.vehicle-manage-deliveries.index") }}">
                                    <i class="fa-fw fas fa-car">

                                    </i>
                                    <span>{{ trans('cruds.vehicleManageDelivery.title') }}</span>
