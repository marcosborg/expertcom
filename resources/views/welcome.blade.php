...
<body>
    ...
    <header id="header" class="fixed-top ">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <a href="index.html" class="logo"><img src="/assets/website/img/logo-white.png" alt="" class="img-fluid"></a>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    @auth
                    <li><a class="getstarted scrollto" href="/admin">Dashboard</a></li>
                    @else
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="member" data-aos="fade-up" data-aos-delay="100">
                            <div class="pic"><img src="/assets/website/img/team/team-1.jpg" class="img-fluid" alt=""></div>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="member">
                            <div class="pic"><img src="/assets/website/img/team/team-2.jpg" class="img-fluid" alt=""></div>
                            <div class="member-info">
                                <h4>Sarah Jhonson</h4>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="member">
                            <div class="pic"><img src="/assets/website/img/team/team-3.jpg" class="img-fluid" alt=""></div>
                            <div class="member-info">
