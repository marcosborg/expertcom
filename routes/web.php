...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    Route::post('recruitment-forms/datatable', 'RecruitmentFormController@index')->name('recruitment-forms.datatable');
    ...
    // Vehicle Manage Entry
    Route::delete('vehicle-manage-entries/destroy', 'VehicleManageEntryController@massDestroy')->name('vehicle-manage-entries.massDestroy');
    Route::post('vehicle-manage-entries/media', 'VehicleManageEntryController@storeMedia')->name('vehicle-manage-entries.storeMedia');
    Route::post('vehicle-manage-entries/ckmedia', 'VehicleManageEntryController@storeCKEditorImages')->name('vehicle-manage-entries.storeCKEditorImages');
    Route::resource('vehicle-manage-entries', 'VehicleManageEntryController');

    // Vehicle Manage Checkin
    Route::delete('vehicle-manage-checkins/destroy', 'VehicleManageCheckinController@massDestroy')->name('vehicle-manage-checkins.massDestroy');
    Route::post('vehicle-manage-checkins/media', 'VehicleManageCheckinController@storeMedia')->name('vehicle-manage-checkins.storeMedia');
    Route::post('vehicle-manage-checkins/ckmedia', 'VehicleManageCheckinController@storeCKEditorImages')->name('vehicle-manage-checkins.storeCKEditorImages');
    Route::resource('vehicle-manage-checkins', 'VehicleManageCheckinController');

    // Vehicle Manage Delivery
